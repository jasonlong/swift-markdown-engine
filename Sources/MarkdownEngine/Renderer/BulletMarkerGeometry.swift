...
public enum MarkdownListMarkerGeometry {
    public static func dotDiameter(for font: NSFont) -> CGFloat {
    ...
    public static func listBaselineY(for font: NSFont) -> CGFloat {
